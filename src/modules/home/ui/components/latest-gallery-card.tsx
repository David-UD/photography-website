...
const LatestGalleryCard = () => {
  return (
    <div className="p-4 lg:p-5 bg-muted rounded-xl w-full flex justify-between items-center">
      <div className="flex items-center gap-2">
        <p className="text-sm font-light">Últimos</p>
        <PiArrowDown size={14} />
      </div>

      <div>
        <Link href="/galerias" className="relative text-sm font-light group">
          Ver todo
...
export default LatestGalleryCard;